...
const EL_VOICE_MAP = {
  ...
  blaze_bold:      'pNInz6obpgDQGcFmaJgB',  // Adam — bold assertive male (was wrong female ID)
  sophia_inspire:  'MF3mGyEYCl7XYWbV9V6O',  // Elli — inspiring female
  ...
  ivy_crisp:       'ThT5KcBeYPX3keUQqHPh',  // Dorothy — crisp female (was Rachel duplicate)
  sterling_pro:    'onwK4e9ZLuTAKqWW03F9',  // Adam variant — professional male
  diana_executive: '21m00Tcm4TlvDq8ikWAM',  // Rachel — executive female
  jake_casual:     'IKne3meq5aSn9XLyUdCD',  // Dave — casual male
  mia_friendly:    'MF3mGyEYCl7XYWbV9V6O',  // Elli — friendly female (was Bella duplicate)
